...
| National Assembly members and proceedings | `data/raw/official_sources/assembly_*`, reconstructed stance/context tables | National Assembly Open Data / Public Data Portal | The member API is listed with no use restriction. Tracked files are rosters, manifests and aggregates; full transcripts, HTML, PDF and sentence corpora are excluded. |

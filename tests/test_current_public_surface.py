...
def test_public_active_alias_matches_current_v29_pointer() -> None:
    ...
    assert current["active_version"] == "v29"
    assert current["runner"] == "scripts/run_active_presidential_model_v29.py"

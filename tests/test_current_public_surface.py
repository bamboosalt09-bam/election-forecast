...
def test_public_active_alias_matches_current_v27_pointer() -> None:
    ...
    assert current["active_version"] == "v27"
    assert current["runner"] == "scripts/run_active_presidential_model_v27.py"

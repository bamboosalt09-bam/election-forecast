...
def test_current_inputs_are_v32_and_separate_forecast_from_history():
    assert figures.ACTIVE_DIR.name == "active_presidential_nested_v32"
    assert figures.FORECAST_DIR.name == "prospective_pres_2025_v32"
...
def test_readme_does_not_present_legacy_figures_as_current():
    ...
    assert "poster_figures/v32_pres_2025_regional_map.png" in readme

...
| 경로 | 현재 역할 |
|---|---|
| `src/election_forecast/` | 설치 가능한 공개 패키지, V32 CLI와 검증된 런타임 로더 |
...
| `scripts/run_current_presidential_model.py` | 현재 V32의 소스 체크아웃 실행 진입점 |
...
| `outputs/active_presidential_nested_v32/` | 변경 금지 V32 산출물과 승격 감사 |
| `outputs/active_presidential_nested_v31/` | 변경 금지 V31 롤백 산출물 |
| `outputs/active_presidential_nested_v23/` ~ `v30/` | 변경 금지 롤백 증거 |
| `outputs/prospective_pres_2025_v32/` | 결과 확인 뒤 수정된 demonstration; prospective 검증이 아님 |

...
|---|---:|---:|---:|---:|:-:|---:|
| **2002** | **1** | **1.0000** | 2.795 | **2.385** | ✗ | **66%** |
| 2007 | 2 | 1.007 | 4.044 | 0.648 | ✓ | 18% |
| 2012 | 3 | 15.04 | 2.387 | 0.157 | ✓ | 4% |
| 2017 | 4 | 13.84 | 2.796 | 0.095 | ✓ | 3% |
| 2022 | 5 | 11.06 | 1.171 | 0.346 | ✓ | 10% |
...
| 선거 | 상쇄율 | 전국 오차 | 지역 절대 |
|---|---:|---:|---:|
| **2002** | **0.240** | **2.385** | 2.795 |
| 2022 | 0.534 | 0.346 | 1.171 |
| 2007 | 0.840 | 0.648 | **4.044** |
| 2012 | 0.934 | 0.157 | 2.387 |
| 2017 | **0.964** | **0.095** | 2.796 |

전국 수치는 지역이 얼마나 맞았는지만이 아니라 **오차가 얼마나 서로를 지우는지**에도 크게 좌우됩니다. V28에서도 2007은 지역 최악(4.044)인데 84.0%가 상쇄돼 전국은 0.648입니다. 패널 평균 상쇄율은 0.686이고, 상쇄율 대 전국오차는 r = −0.858인 반면 지역정확도 대 전국오차는 r = 0.191입니다.

극단은 홍준표 2017입니다 — 전국 오차 **+0.058%p**, 지역 절대오차 **3.377%p**, 상쇄율 **0.983**. V28이 계승한 지역 양극화 보정으로 절대오차는 줄었지만 전국값이 정확해 보이는 데 상쇄가 크게 기여한다는 사실은 남습니다.

2002가 패널 최악인 이유도 이것입니다. 지역 오차는 2.795로 중간인데 **상쇄율이 0.240으로 최저** — 오차가 보상적이 아니라 계통적입니다.

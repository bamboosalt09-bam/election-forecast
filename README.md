...
따라서 **전국 0.7262%p를 지역 수준이 맞다는 증거로 읽으면 안 됩니다.** 전체 논의의 출발점은 [오차 상쇄 진단](docs/DIAGNOSIS_ERROR_CANCELLATION_20260822.md)에 있습니다. 해당 문서의 상세 수치는 V27 진단이며, V28은 외부모델 파생 입력 제거로 소폭 달라졌습니다.

"""Build a fresh confirmatory corpus after V22 is frozen."""
...
SEED = "stance-context-v22-confirmatory-10000-v1"
...
def main() -> None:
    ...
    output_path = output_dir / "stance_context_v22_confirmatory_10000.csv"
    ...
    if selected_path.exists():
        ...
        print("[V22 confirmatory selection] resuming", flush=True)
    else:
        excluded = _existing_shadow_hashes()
        print(f"[V22 confirmatory selection] excluded hashes: {len(excluded):,}", flush=True)
    ...
    state = {
        "status": "v22_confirmatory_corpus_complete",
        "rows": len(output),
        "seed": SEED,

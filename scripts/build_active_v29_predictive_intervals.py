"""Build chronological predictive intervals for V29."""
...
INPUT = ROOT / "outputs/active_presidential_nested_v29/nested_predictions.csv"
OUTPUT_DIR = ROOT / "outputs/active_presidential_nested_v29"


def build(*, n_sim: int = 50_000, seed: int = 29_820, output_dir: Path = OUTPUT_DIR):
    ...
    payload["schema"] = "active_v29_national_predictive_intervals_v1"
    payload["model_version"] = "v29"
    payload["development_outcome_warning"] = (
        "V29 expands the regional dispersion a third candidate compresses. The "
...
def main() -> None:
    ...
    parser.add_argument("--seed", type=int, default=29_820)

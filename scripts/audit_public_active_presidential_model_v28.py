"""Audit active V28 and all frozen V23–V27 rollback boundaries."""
...
def main() -> None:
    ...
    require(pointer["active_version"] == "v28", "active pointer is not V28")
    ...
    require(len(frame) == 232, "V28 row drift")
    ...
    print("[active V28 public audit: PASS]")
    print(f"v28_prediction_sha256={sha(ACTIVE_DIR / 'nested_predictions.csv')}")

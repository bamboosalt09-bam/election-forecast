...
from scripts import run_prospective_forecast_v30 as v30  # noqa: E402

FROZEN = ROOT / "outputs/prospective_pres_2025_v30"
...
def main() -> None:
    ...
    if absent:
        print("[V30 prospective reproduction: SKIPPED - required input unresolved]")
    ...
    original = v30.OUTPUT_DIR
    with tempfile.TemporaryDirectory(prefix="election_forecast_v30_prospective_") as temporary:
        destination = Path(temporary) / "prospective_pres_2025_v30"
        try:
            v30.OUTPUT_DIR = destination
            v30.run()
        finally:
            v30.OUTPUT_DIR = original
    ...
    print("[V30 prospective reproduction: PASS]")

"""Build regional-party routing with party and candidate ballots separated."""
...
OUTPUT_DIR = ROOT / "outputs" / "semantic_regional_party_alignment_v17"
...
def main() -> None:
    ...
    automatic, audit = build_automatic_nonmajor_alignment(
        ...
        landscape,
        bloc_landscape,
        type_weights=SEMANTIC_HISTORY_TYPE_WEIGHTS,
    )
    ...
    events.to_csv(
        OUTPUT_DIR / "semantic_history_identity_events.csv",
        index=False,
        encoding="utf-8-sig",
    )
    summary = {
        "schema": "semantic_regional_party_alignment_v17",

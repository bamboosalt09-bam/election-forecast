"""Build district-first candidate regional base inputs through 2022."""
...
OUTPUT_DIR = ROOT / "outputs" / "district_reconstructed_candidate_base_v6"


def main() -> None:
    history = pd.read_csv(OFFICIAL_DIR / "nec_candidate_history.csv", encoding="utf-8-sig")
    ...
    summary = {
        "schema": "district_reconstructed_candidate_base_build_v6",

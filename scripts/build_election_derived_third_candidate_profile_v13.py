"""Build the prior-election third-candidate profile used by the v13 ablation."""
...
from presidential_issue_engine.election_derived_third_candidate_profile import (  # noqa: E402
    build_election_derived_third_profile,
)


OUTPUT_DIR = ROOT / "outputs" / "election_derived_third_candidate_profile_v13"


def main() -> None:
    profile, audit = build_election_derived_third_profile(
        pd.read_csv(
            ROOT
            / "outputs"
    ...
    summary = {
        "schema": "election_derived_third_candidate_profile_v13",

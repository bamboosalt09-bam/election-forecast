"""Run the outcome-free 2025 demonstration through the promoted V29 layer."""
...
OUTPUT_DIR = ROOT / "outputs" / "prospective_pres_2025_v29"
...
WEIGHT_COLUMN = "v29_prior_election_vote_weight"
...
def _expand_in_place() -> None:
    ...
    added = [
        ...
        ROOT / "scripts/run_prospective_forecast_v29.py",
        ROOT / "scripts/run_active_presidential_model_v29.py",
    ]
    manifest = (
        pd.concat(
            [
    ...
    payload["v29_third_share_dispersion_expansion"] = {

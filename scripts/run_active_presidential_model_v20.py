"""Run active V20 with automated viability and two character fields."""
...
OUTPUT_DIR = ROOT / "outputs" / "active_presidential_nested_v20"
ASSIGNMENT_DIR = ROOT / "outputs" / "preliminary_slot_assignment_v20"
FOOTPRINT_BASE = (
...
def main() -> None:
    ...
    promotion = {
        "schema": "active_presidential_model_promotion_v20",
        "status": "active",
        ...
        "experiment_lineage": [
            ...
            "automatic_third_character_v20b:anti_major_and_regional_overlap",
        ],
        "post_2022_outcomes_used": False,
        "target_outcome_fields_used_by_new_layers": [],
        "automatic_third_viability": True,
        "automatic_third_character_fields": [
            "anti_major_party_appeal",
            "regional_base_overlap",
        ],
        "manual_third_character_fields_retained": ["centrist_appeal"],

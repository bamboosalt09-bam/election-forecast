"""Build chronological predictive intervals for V28."""
...
INPUT = ROOT / "outputs/active_presidential_nested_v28/nested_predictions.csv"
OUTPUT_DIR = ROOT / "outputs/active_presidential_nested_v28"


def build(*, n_sim: int = 50_000, seed: int = 28_820, output_dir: Path = OUTPUT_DIR):
...
def main() -> None:
    ...
    parser.add_argument("--seed", type=int, default=28_820)

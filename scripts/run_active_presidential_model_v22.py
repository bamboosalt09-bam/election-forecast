"""Run active V22 with automatic issue, policy, and third-candidate controls."""
...
from scripts import build_automatic_controls_v22 as automatic_v22  # noqa: E402
...
CONFIG = ROOT / "data" / "config" / "active_presidential_model_v22.json"
OUTPUT_DIR = ROOT / "outputs" / "active_presidential_nested_v22"
ASSIGNMENT_DIR = ROOT / "outputs" / "preliminary_slot_assignment_v22"
FOOTPRINT_BASE = (
    ...
    extra = pd.DataFrame(
        [
            ...
            for path in (
                ASSEMBLY,
                PARTY_TRANSITIONS,
                ROOT / "data" / "raw" / "regional_policy_commitments.csv",
...
def main() -> None:
    ...
    automatic_v22.build(
        status="active_v22_with_retained_shadow_inputs",
    ...
    promotion = {
        "schema": "active_presidential_model_promotion_v22",
        "status": "active",
        "predecessor": "active_v21",
        "experiment_lineage": [
            "active_v21",
            "automatic_controls_v22_ablation",
            "priority_policy_mega_third_responsibility",
        ],
        "methodology_priority": "activate only the minimum passing automatic-control bundle",
        "same_formula_all_regions": True,
        "manual_candidate_alignment_rows_used": False,
        "manual_policy_effect_sizes_used": False,
        "automatic_mega_taxonomy_active": True,
        "automatic_third_context_active": True,
        "automatic_responsibility_inputs_active": True,
        "generation_weights_status": "shadow_due_to_sparse_prior_reports_and_small_regression",
        "behavioral_genealogy_status": "shadow_due_to_missing_direct_party_pairs",
        "withdrawal_transfer_rate_mode": "semiautomatic_scenario_input_retained",
        ...
        "performance_improvement_claim": True,
        ...
        "rollback_checkpoint": "backups/model_checkpoints/20260802_pre_automatic_policy_v22",
    }
